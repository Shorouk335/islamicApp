...
class CustomSalatTimeBox extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    double paddingValue =
        ResponsiveBreakpoints.of(context).largerThan(TABLET) ? 8.0 : 5.0;
    double height =
        ResponsiveBreakpoints.of(context).largerThan(TABLET) ? 80.0 : 50.0;
    return Container(
      height: height,
      ...
      decoration: BoxDecoration(
        ...
        color:
            active ? ColorManager.lightBlueColor : ColorManager.lightBeigeColor,
      ),
      child: Row(
